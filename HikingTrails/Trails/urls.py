...
from HikingTrails.Trails.views import TrailsListView, TrailsDetailView, TrailsCreateView, TrailDeleteView, CommentCreateView
...
urlpatterns = [
    ...
    # path('<int:pk>/comment/', create_comment, name='comment_trail'),
]
